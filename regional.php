    ...
    <div class="container my-4">
        <div class="row mb-2">
            <div class="col-md-6">
              <div class="row no-gutters border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
                <div class="col p-4 d-flex flex-column position-static">
                  <strong class="d-inline-block mb-2 text-primary">Best of Hindi</strong>
                  <h3 class="mb-0">Best Hindi songs of 2022</h3>
                  <div class="mb-1 text-muted">Nov 12</div>
                  <p class="card-text mb-auto">Best of latest and trending from Badshah,AP Dillon to Arijit Singh,Armaan Malik,Shreya Ghosal and many others</p>
                  <a href="Musify/hindi.php" id="playlist1" class="stretched-link">Go to playlist</a>
                </div>
            ...
            <div class="col-md-6">
              <div class="row no-gutters border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
                <div class="col p-4 d-flex flex-column position-static">
                  <strong class="d-inline-block mb-2 text-success">Best of French Songs</strong>
                  <h3 class="mb-0">Best of French Songs 2022</h3>
                  <div class="mb-1 text-muted">Nov 11</div>
                  <p class="mb-auto">Songs in Spanish,Hindi,African languages and many more are available</p>
                  <a href="Musify/classical.php" id="playlist2" class="stretched-link">Go to playlist</a>
                </div>
                <div class="col-auto d-none d-lg-block">

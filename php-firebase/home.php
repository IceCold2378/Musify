    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
            <form action="checklogin.php" method="post" id="loginpg">
  ...
  <div class="modal fade" id="signupModal" tabindex="-1" role="dialog" aria-labelledby="signupModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
            <form action="connect.php" method="post" id="signuppg">
                <div class="form-group">
                ...
                <img src="m1.jpg" class="d-block w-100" width="1600" height ="600" alt="...">
                  <div class="carousel-caption d-none d-md-block">
                    <div class="textalign">
                      ...
                      <button class="btn btn-danger"><a href="todayhits.html" class="button-link">Today's Top Hits</a></button>
                      <button class="btn btn-primary"><a href="risingartists.html" class="button-link">Rising Artists</a></button>
                      <button class="btn btn-success"><a href="top10global.html" class="button-link">Top 50 Global</a></button>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6">
              <div class="row no-gutters border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
                <div class="col p-4 d-flex flex-column position-static">
                  ...
                  <a href="Musify/index.html" id="playlist1" class="stretched-link">Go to playlist</a>
                </div>
            ...
            <div class="col-md-6">
              <div class="row no-gutters border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
                <div class="col p-4 d-flex flex-column position-static">
                  ...
                  <a href="Musify/classical.html" id="playlist2" class="stretched-link">Go to playlist</a>
                </div>
                <div class="col-auto d-none d-lg-block">
            ...
            <div class="col-md-6">
              <div class="row no-gutters border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
                <div class="col p-4 d-flex flex-column position-static">
                  ...
                  <a href="Musify/edm.html" id="playlist3" class="stretched-link">Go to playlist</a>
                </div>
                <div class="col-auto d-none d-lg-block">
            ...
            <div class="col-md-6">
              <div class="row no-gutters border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
                <div class="col p-4 d-flex flex-column position-static">
                  ...
                  <a href="Musify/pop.html" id="playlist4" class="stretched-link">Go to playlist</a>
                </div>
                <div class="col-auto d-none d-lg-block">
